...
from . import views
from .views import MailingStartView, RegisterView
...
urlpatterns = [
    ...
    path('mailings/<int:pk>/start/', MailingStartView.as_view(), name='mailing-start'),
    path('attempts/', views.MailingAttemptListView.as_view(), name='attempt-list'),
